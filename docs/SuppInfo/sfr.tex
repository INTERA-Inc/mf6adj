...
Where the flows do not determine the rule, which happens when a reach has nothing to give and every rule diverts nothing, \adj{} reports the diversion and holds its flow fixed rather than returning a partial derivative silently.
