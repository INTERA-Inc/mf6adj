...
\begin{figure}[htb]
	...
	largest. Open circles mark the cells the lake occupies and the square marks
	the pumped cell. The lake is connected to the aquifer through that layer
	only, so the capture is the response the water balance of this chapter
	describes, without the approximations noted at the end.}
