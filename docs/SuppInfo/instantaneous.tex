...
\noindent which is a map over the model of the immediate effect of pumping. Because the steps are solved independently, this map does not change when other observation times are added to the same measure.
