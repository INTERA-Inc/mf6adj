...
\begin{equation}
	...
	\frac{\partial Q_{SS}}{\partial S_s} = \frac{A \Delta z}{\Delta t^{k}}
	\left[ \left. \left( TOP - h^{k} \right) \right|_{S_F^{k} = 1}
	+ \left. \left( h^{k-1} - TOP \right) \right|_{S_F^{k-1} = 1} \right].
\end{equation}
...
\begin{table}[h]
	...
	\begin{tabular}{lrr}
		\toprule
		Parameter & Saturation taken once & Saturation at both ends \\
		\midrule
