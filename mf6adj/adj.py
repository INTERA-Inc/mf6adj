        ...
        with _utils_cd(self.working_directory):
            ...
            while ctime < etime:
                ...
                if sat_old is None:
                    ...
                    sat_old = storage.initial_saturation(self._gwf, self._gwf_name)
                ...
                if has_sto:  # has storage
                    dresdss_h = storage.dresdss_h(
                        self._gwf, self._gwf_name, head, head_old, dt1, sat, sat_prev
                    )
                    data_dict["dresdss_h"] = dresdss_h
                    dresdsy_h = storage.dresdsy_h(
                        self._gwf, self._gwf_name, dt1, sat, sat_prev
                    )
