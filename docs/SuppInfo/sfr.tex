...
\begin{figure}[htb]
	...
	rather than from storage or from another boundary. Open circles mark the
	cells the reaches occupy and the square marks the pumped cell. The reach
	depths are solved with the flow equations as described in this chapter.}
